...
public class JianDeXmlParser2 {
    ...
    public static void main(String[] args) {
        ...
        // parserProgressXml("C:/Users/Administrator/Desktop/病程/胸痛病历/10112193/病程记录.xml");
    ...
    public static void parserProgressXml(String xmlStr) {
        try {
            ...
            // getName(getElement(XTextDocument, 3, 1, 5, 0, 3, 0, 4, 1, 3, 0,
            // 3, 1, 13));
            // getName(getElement(XTextDocument, 3, 1, 5, 0, 3, 0, 4, 1, 3, 1,
            // 3, 1, 13));
            // getName(getElement(XTextDocument, 3, 1, 5, 0, 3, 0, 4, 1, 3, 2,
            // 3, 1, 13));
            // getName(getElement(XTextDocument, 3, 1, 5, 0, 3, 0, 4, 1, 3, 3,
            // 3, 1, 13));
            // getName(getElement(XTextDocument, 3, 1, 5, 0, 3, 0, 4, 2, 3, 0,
            // 3, 1, 11, 1));
            // getName(getElement(XTextDocument, 3, 1, 5, 0, 3, 0, 4, 2, 3, 0,
            // 3, 1, 12));
            // getName(getElement(XTextDocument, 3, 1, 5, 0, 3, 0, 4, 2, 3, 2,
            // 3, 1, 12));
            // getName(getElement(XTextDocument, 3, 1, 5, 0, 3, 0, 4, 2, 3, 3,
            // 3, 1, 12));
            // getName(getElement(XTextDocument, 3, 1, 5, 0, 3, 12, 7, 0, 8, 0,
            // 1));
            // getName(getElement(XTextDocument, 3, 1, 5, 0, 3, 16, 11));
            // getName(getElement(XTextDocument, 3, 1, 5, 0, 3, 24, 11));
            // getName(getElement(XTextDocument, 3, 1, 5, 0, 3, 26, 4, 0, 3, 0,
            // 3, 1, 13));
            // getName(getElement(XTextDocument, 3, 1, 5, 0, 3, 26, 4, 0, 3, 1,
            // 3, 1, 11, 0));
            // getName(getElement(XTextDocument, 3, 1, 5, 0, 3, 26, 4, 0, 3, 1,
            // 3, 1, 12));
