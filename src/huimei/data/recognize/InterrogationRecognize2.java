...
public class InterrogationRecognize2 {
    ...
    public static void main(String[] args) {
        ...
        path = path + "\\src\\" + InterrogationRecognize2.class.getPackage().getName().replace('.', '\\');
        ...
        try {
                ...
                if (StringUtils.isNotEmpty(data1)) {
                    ...
                    for (String d : ds) {
                        ...
                        try {
                            ...
                            Set<String> callback1 = result1.getJSONObject("body").getJSONObject("debugInfo")
                                    .keySet();
                            info.setHmDebug(0);
                            String str2 = pushService.push("http://10.117.64.153:8080",
                                    "/v_2_2/diagnose_through_interrogation", info);
                            JSONObject result2 = JSONObject.parseObject(str2);
                            Set<String> callback2 = result2.getJSONObject("body")
            ...
            export.saveFile(new File(resultPath, "classification_result_interrogation_13.xls"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
